...
def build_frozen_pack() -> dict:
    return {
        "packId": "frozen-pack-curated-preview-v1",
        "cases": [
            {
                "caseId": "VIG-CURATED-001",
                "vignette": {
                    "cancerType": "NSCLC",
                    "diseaseSetting": "metastatic",
                    "histology": "squamous",
                ...
                "reference": {
                    "expectedTopEvidence": ["PMID-40118215", "PMID-40446626"],
                    "expectedLabelByEvidenceId": {
                        "PMID-40118215": "aligned",
                        "PMID-40446626": "aligned",
                    },
                },
            }
        ],
...
def main() -> None:
    ...
    print(f"Wrote curated frozen pack -> {FROZEN_CANONICAL_PATH.relative_to(ROOT)}")
