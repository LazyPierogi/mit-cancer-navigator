...
export function WorkspaceForm() {
  ...
  function updateBrainMetastases(value: NonNullable<VignetteInput["clinicalModifiers"]>["brainMetastases"]) {
    setActivePresetId(null);
    setPayload((current) => ({
      ...current,
      clinicalModifiers: {
        ...(current.clinicalModifiers ?? { brainMetastases: "unspecified" }),
        brainMetastases: value
      }
    }));
  }
        ...
        <fieldset className="form-section">
          ...
          <div className="form-fields fields-4col">
            ...
            <label>
              Disease stage
              <select
                value={payload.diseaseStage ?? "unspecified"}
                onChange={(e) => updateField("diseaseStage", e.target.value as VignetteInput["diseaseStage"])}
              >
          ...
          <div className="form-fields fields-4col">
            <label>
              Resectability
              <select
                value={payload.resectabilityStatus ?? "not_applicable"}
                onChange={(e) => updateField("resectabilityStatus", e.target.value as VignetteInput["resectabilityStatus"])}
              >
                <option value="resected">Resected</option>
                <option value="unresectable">Unresectable</option>
            ...
            <label>
              Treatment context
              <select
                value={payload.treatmentContext ?? "unspecified"}
                onChange={(e) => updateField("treatmentContext", e.target.value as VignetteInput["treatmentContext"])}
              >
                <option value="treatment_naive">Treatment naive</option>
                <option value="post_platinum_chemotherapy">Post platinum chemotherapy</option>
                <option value="post_egfr_tki">Post EGFR TKI</option>
                <option value="post_chemo_immunotherapy">Post chemo-immunotherapy</option>
                <option value="post_chemoradiation">Post chemoradiation</option>
            ...
            <label>
              Brain metastases
              <select
                value={payload.clinicalModifiers?.brainMetastases ?? "unspecified"}
                onChange={(e) => updateBrainMetastases(e.target.value as NonNullable<VignetteInput["clinicalModifiers"]>["brainMetastases"])}
              >
