...
// --- Mock Data & Constants ---
const HISTOLOGY_OPTIONS = ["Adenocarcinoma", "Squamous Cell", "Large Cell"];
const BIOMARKERS = ["EGFR+", "ALK+", "ROS1+", "PD-L1 > 50%", "Wild Type"];
const LINES_OF_THERAPY = ["1st Line", "2nd Line", "3rd Line+"];

const PATIENT_PRESETS = [
    { id: 1, name: "Patient 1", desc: "Standard Presentation", data: { histology: 'Adenocarcinoma', biomarker: 'EGFR+', line: '1st Line', custom: '' } },
    { id: 2, name: "Patient 2", desc: "Complex Case", data: { histology: 'Squamous Cell', biomarker: 'Wild Type', line: '2nd Line', custom: 'High toxicity profile' } },
    { id: 3, name: "Patient 3", desc: "Advanced Stage", data: { histology: 'Large Cell', biomarker: 'ALK+', line: '3rd Line+', custom: 'CNS Metastases' } },
];
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                {PATIENT_PRESETS.map(preset => (
                                    ...
                                    >
                                        ...
                                        <span className={`text-[9px] mt-0.5 ${activePreset === preset.id ? 'text-white/80' : STYLES.textLight}`}>{preset.id === 1 ? 'Standard' : 'Case'}</span>
                                    </button>
                                ))}
                            </div>
                        </div>
